...
__decorate([
    (0, mongoose_1.Prop)({ type: [String], enum: enums_1.Orientacion, required: true }),
    __metadata("design:type", Array)
], Ngo.prototype, "orientacion", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: [String], enum: enums_1.AreaInfluencia, required: true }),
...
__decorate([
    (0, mongoose_1.Prop)({
        type: [{ type: mongoose_2.default.Schema.Types.ObjectId, ref: "RegisteredUser" }],
    }),
    __metadata("design:type", Array)
], Ngo.prototype, "suscribed_users", void 0);
Ngo = __decorate([
    (0, mongoose_1.Schema)()
], Ngo);
exports.Ngo = Ngo;
